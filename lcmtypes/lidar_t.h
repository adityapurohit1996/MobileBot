 ...
 */
typedef struct _lidar_t_subscription_t lidar_t_subscription_t;

/**
 * Prototype for a callback function invoked when a message of type
 * lidar_t is received.
 */
typedef void(*lidar_t_handler_t)(
    const lcm_recv_buf_t *rbuf, const char *channel,
    const lidar_t *msg, void *userdata);

/**
 * Publish a message of type lidar_t using LCM.
 *
 ...
 */
int lidar_t_publish(lcm_t *lcm, const char *channel, const lidar_t *msg);

/**
 * Subscribe to messages of type lidar_t using LCM.
 *
 ...
 */
lidar_t_subscription_t* lidar_t_subscribe(
    lcm_t *lcm, const char *channel, lidar_t_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by lidar_t_subscribe()
 */
 ...
 * @return 0 on success, <0 if an error occured
 */
int lidar_t_subscription_set_queue_capacity(
    lidar_t_subscription_t* subs, int num_messages);
...
int __lidar_t_encode_array(
    void *buf, int offset, int maxlen, const lidar_t *p, int elements);
int __lidar_t_decode_array(
    const void *buf, int offset, int maxlen, lidar_t *p, int elements);
